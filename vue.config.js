...
const striptags = require('./examples/assets/js/strip-tags');
const utils = require('./examples/assets/js/utils');
...
module.exports = {
  chainWebpack: (config) => {
    ...
    config.resolve.alias
      .set('@', '/Users/zhangxiaohu/Desktop/xrui/examples')
      .set('@src', '/Users/zhangxiaohu/Desktop/xrui/src');
